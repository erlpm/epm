...
needed_files(_, FoundFiles, _, AppInfo) ->
    ...
    MibFirstConf = epm_opts:get(EpmOpts, mib_first_files, []),
    ...
    Opts = epm_opts:get(epm_app_info:opts(AppInfo), mib_opts, []),
...
compile(Source, OutDirs, _, Opts) ->
    ...
    ok = epm_file_utils:ensure_dir(BinOut),
    ok = epm_file_utils:ensure_dir(HrlOut),
    ...
    case snmpc:compile(Source, AllOpts) of
        {ok, _} ->
            ...
            epm_file_utils:mv(HrlFilename, HrlOut),
            ok;
