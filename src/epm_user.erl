...
%%% to epm_user.erl and modified in a few place to force a shell to always
%%% boot or to remove dead comments.
%%%
%%% Its usage is required because unlike the standard (new) shell, it is
%%% not possible to get rid of the old one without killing the epm escript
...
-export([
    start/0, start/1, start_out/0,interfaces/1
]).
