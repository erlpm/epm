...
-export([encode_msg/2, encode_msg/3
    ...
    ,enum_symbol_by_value_RetirementReason/1, enum_value_by_symbol_RetirementReason/1
    ,get_service_names/0
    ,get_service_def/1
    ,get_rpc_names/1
    ...
    ,uses_packages/0
    ,source_basename/0
    ,get_all_source_basenames/0
    ,get_all_proto_names/0
    ,get_msg_containment/1
    ,get_pkg_containment/1
    ,get_service_containment/1
    ,get_rpc_containment/1
    ,get_enum_containment/1
    ,get_proto_by_msg_name_as_fqbin/1
    ,get_proto_by_service_name_as_fqbin/1
    ,get_proto_by_enum_name_as_fqbin/1
    ,get_protos_by_pkg_name_as_fqbin/1
...
source_basename() -> "erlpm_pb_package.proto".
...
get_all_source_basenames() -> ["erlpm_pb_package.proto"].
...
%% functions.
get_all_proto_names() -> ["erlpm_pb_package"].


get_msg_containment("erlpm_pb_package") ->
...
get_pkg_containment("erlpm_pb_package") -> undefined;
get_pkg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_service_containment("erlpm_pb_package") -> [];
get_service_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_rpc_containment("erlpm_pb_package") -> [];
get_rpc_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_enum_containment("erlpm_pb_package") ->
    ['RetirementReason'];
