...
%% with modifications:
%% - Change module name to `erlpm_erl_tar`
...
%% - Allow setting file_info opts on :erlpm_erl_tar.add
...
%%  - compressed: Uncompressed the tar file when reading
...
safe_relative_path_links([Segment | Segments], Cwd, PrevLinks, Acc) ->
    ...
    case erlpm_filename:safe_relative_path(AccSegment) of
        unsafe ->
            unsafe;
