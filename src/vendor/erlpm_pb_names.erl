...
-module(erlpm_pb_names).

-export([encode_msg/2, encode_msg/3
    , decode_msg/2, decode_msg/3
    , merge_msgs/3, merge_msgs/4
    , verify_msg/2, verify_msg/3
    , get_msg_defs/0, get_msg_names/0, get_group_names/0, get_msg_or_group_names/0, get_enum_names/0
    , find_msg_def/1, fetch_msg_def/1
    , find_enum_def/1, fetch_enum_def/1
    , enum_symbol_by_value/2, enum_value_by_symbol/2
    , get_service_names/0, get_service_def/1, get_rpc_names/1
    , find_rpc_def/2, fetch_rpc_def/2
    ...
    , fqbin_to_msg_name/1
    , msg_name_to_fqbin/1
    , fqbin_to_enum_name/1
    , enum_name_to_fqbin/1
    , get_package_name/0
    , uses_packages/0
    , source_basename/0
    , get_all_source_basenames/0, get_all_proto_names/0, get_msg_containment/1, get_pkg_containment/1
    , get_service_containment/1, get_rpc_containment/1, get_enum_containment/1
    , get_proto_by_msg_name_as_fqbin/1
    , get_proto_by_service_name_as_fqbin/1
    , get_proto_by_enum_name_as_fqbin/1, get_protos_by_pkg_name_as_fqbin/1
    , gpb_version_as_string/0, gpb_version_as_list/0
]).
...
source_basename() -> "erlpm_pb_names.proto".
...
get_all_source_basenames() -> ["erlpm_pb_names.proto"].
...
%% functions.
get_all_proto_names() -> ["erlpm_pb_names"].


get_msg_containment("erlpm_pb_names") ->
    ['Names', 'Package'];
get_msg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_pkg_containment("erlpm_pb_names") -> undefined;
get_pkg_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_service_containment("erlpm_pb_names") -> [];
get_service_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_rpc_containment("erlpm_pb_names") -> [];
get_rpc_containment(P) ->
    error({gpb_error, {badproto, P}}).


get_enum_containment("erlpm_pb_names") -> [];
