...
init_per_testcase(_, Config) ->
    epm_test_utils:init_epm_state(Config, "as_").
...
as_basic(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_basic_"),
...
as_multiple_profiles(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_multiple_profiles_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
as_multiple_tasks(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_multiple_tasks_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
as_multiple_profiles_multiple_tasks(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_multiple_profiles_multiple_tasks_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
as_comma_placement(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_comma_placement_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
as_comma_then_space(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_comma_then_space_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
as_dir_name(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_dir_name_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
as_with_task_args(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_with_task_args_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
warn_on_empty_profile(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_warn_empty_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),

    meck:new(epm_log, [passthrough]),
    epm_test_utils:run_and_check(Config,
                                   [],
...
error_on_empty_tasks(Config) ->
    ...
    Name = epm_test_utils:create_random_name("as_error_empty_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
...
warn_match(App, History) ->
    lists:any(
        fun({_, {epm_log,log, [warn, "No entry for profile ~ts in config.",
            [ArgApp]]}, _}) -> ArgApp =:= App
        ;  (_) ->
            false
        end,
...
clean_as_profile(Config) ->
    ...
    Name = epm_test_utils:create_random_name("clean_as_profile_"),
    Vsn = epm_test_utils:create_random_vsn(),
    epm_test_utils:create_app(AppDir, Name, Vsn, [kernel, stdlib]),
